...
<table class="entityShow">
    <tr>
        <th><g:message code="project.createDate"/></th>
        <td><g:formatPlainDate value="${project.createDate}"/></td>
    </tr>
    <tr>
        <th><g:message code="project.customer"/></th>
        <td></td>
    </tr>
    <tr>
        <th><g:message code="project.department"/></th>
        <td></td>
    </tr>
    <tr>
        <th><g:message code="project.city"/></th>
        <td></td>
    </tr>
    <tr>
        <th><g:message code="project.contactPerson"/></th>
        <td></td>
    </tr>

    <tr>
        <th><g:message code="project.contactPhone"/></th>
        <td></td>
    </tr>

    <tr>
        <th><g:message code="project.releaseDate"/></th>
        <td></td>
    </tr>

</table>

    %{--project.createDate=Дата создания--}%
    %{--=Конечный пользователь--}%
    %{--=Подразделение--}%
    %{--project.city=Город расположения--}%
    %{--=Контактное лицо--}%
    %{--=Контактная информация--}%
    %{--=Планируемая дата реализации проекта--}%
    %{--project.sum=Сумма проекта--}%
    %{--project.status=Статус проекта--}%
    %{--project.dealer=Исполнитель проекта--}%
    %{--project.comments=Примечание--}%
    %{--project.closeDate=Дата закрытия--}%
